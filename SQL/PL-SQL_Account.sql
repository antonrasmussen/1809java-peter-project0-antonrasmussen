...
--USED FOR CALLABLE STATEMENT IN JDBC
  CREATE OR REPLACE PROCEDURE INSERT_ACCOUNT (ACCT_TYPE VARCHAR2, STATUS VARCHAR2, BALANCE NUMBER, CUSTOMER_ID  NUMBER)
  AS
  BEGIN
    INSERT INTO ACCOUNT VALUES(NULL, ACCT_TYPE, STATUS, BALANCE, CUSTOMER_ID, NULL);
    COMMIT;
  END;